...
License  : ZPL-2.1
Requires: repoze.sphinx.autointerface-python3
Requires: repoze.sphinx.autointerface-license
Requires: repoze.sphinx.autointerface-python
Requires: Sphinx
Requires: setuptools
...
export LANG=C
export SOURCE_DATE_EPOCH=1539353731
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/repoze.sphinx.autointerface
cp LICENSE.txt %{buildroot}/usr/share/doc/repoze.sphinx.autointerface/LICENSE.txt
...
/usr/share/doc/repoze.sphinx.autointerface/LICENSE.txt
